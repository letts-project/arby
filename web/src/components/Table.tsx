  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          '-mx-1 inline-flex items-center gap-1 rounded px-1 transition-colors hover:text-foreground focus:outline-none focus-visible:ring-1 focus-visible:ring-ring',
